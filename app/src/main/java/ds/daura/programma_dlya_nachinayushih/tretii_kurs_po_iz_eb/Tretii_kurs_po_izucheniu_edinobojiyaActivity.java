...
public class Tretii_kurs_po_izucheniu_edinobojiyaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Часть 11"));
        tabLayout.addTab(tabLayout.newTab().setText("Часть 12"));
        tabLayout.addTab(tabLayout.newTab().setText("Часть 13"));
        tabLayout.addTab(tabLayout.newTab().setText("Часть 14"));

        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);


        final ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager);
        final TreriiPageAdapter adapter = new TreriiPageAdapter(getSupportFragmentManager(), tabLayout.getTabCount(), 1);
